...
\subsection*{TaskAssignmentPageCode.py}

\inputminted[fontsize=\small, breaklines, breakanywhere, breakindent=1em]{py}{../../TaskAssignmentPageCode.py}

\newpage

\subsection*{TaskAssignmentPageUI.py}

\inputminted[fontsize=\small, breaklines, breakanywhere, breakindent=1em]{py}{../../TaskAssignmentPageUI.py}

\newpage

\section*{Output:}
\subsection*{Task Assignment Page}
\includegraphics[width=\textwidth]{../images/TaskAssignmentPageResult1.png} \\
\\
\includegraphics[width=\textwidth]{../images/TaskAssignmentPageResult2.png} \\
\\
\includegraphics[width=\textwidth]{../images/TaskAssignmentPageResult3.png} \\
\\
\includegraphics[width=\textwidth]{../images/TaskAssignmentPageResult4.png} \\
\\
\includegraphics[width=\textwidth]{../images/TaskAssignmentPageResult5.png} \\
\\
\includegraphics[width=\textwidth]{../images/TaskAssignmentPageResult6.png} \\
\\
\includegraphics[width=\textwidth]{../images/TaskAssignmentPageResult7.png} \\
