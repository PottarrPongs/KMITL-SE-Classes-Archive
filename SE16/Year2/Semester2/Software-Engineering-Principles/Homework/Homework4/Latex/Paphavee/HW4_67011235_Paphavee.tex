...
\section*{Code:}
\subsection*{MainPageCode.py}

\inputminted[fontsize=\small, breaklines, breakanywhere, breakindent=1em]{py}{../../MainPageCode.py}

\newpage

\subsection*{MainPageUI.py}

\inputminted[fontsize=\small, breaklines, breakanywhere, breakindent=1em]{py}{../../MainPageUI.py}
