...
\subsection*{DesignPage.py}

\inputminted[fontsize=\small, breaklines, breakanywhere, breakindent=1em]{py}{../../DesignPage.py}

\subsection*{UserSettingsPage.py}

\inputminted[fontsize=\small, breaklines, breakanywhere, breakindent=1em]{py}{../../UserSettingsPage.py}
