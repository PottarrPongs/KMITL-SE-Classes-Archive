...
\texttt{profile.png} \\
\includegraphics[width=0.2\textwidth]{../images/profile.jpg} \\

\subsection*{Sound:}

\begin{itemize}
    \item \texttt{hover.wav}
    \item \texttt{page\_toggle.wav}
    \item \texttt{save\_button.wav}
\end{itemize}
