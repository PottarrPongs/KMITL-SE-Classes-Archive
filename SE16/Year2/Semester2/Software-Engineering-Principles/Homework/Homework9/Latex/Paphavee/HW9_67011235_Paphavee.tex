...
\begin{itemize}
    \item \textbf{Main Page}: Home page of the program root for navigate
        to other pages
\end{itemize}
...
\section*{Code:}
\subsection*{HW9\_67011235\_Paphavee.html}

\inputminted[fontsize=\small, breaklines, breakanywhere, breakindent=1em]{py}{../../HW9_67011235_Paphavee.html}

\newpage

\subsection*{HW9\_67011235\_Paphavee.py}

\inputminted[fontsize=\small, breaklines, breakanywhere, breakindent=1em]{py}{../../HW9_67011235_Paphavee.py}
...
\texttt{active.png} \\
\includegraphics[width=0.05\textwidth]{../../images/active.png} \\
\texttt{member.png} \\
\includegraphics[width=0.1\textwidth]{../../images/member.png} \\
...
\includegraphics[width=\textwidth]{../images/MainPage1.png} \\
\\
\includegraphics[width=\textwidth]{../images/MainPage2.png} \\
\end{document}
